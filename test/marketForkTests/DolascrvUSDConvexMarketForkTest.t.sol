...
contract DolascrvUSDConvexMarketForkTest is MarketBaseForkTest {
    ConvexEscrowV2 escrow;

    CurveLPPessimisticFeed feedDolascrvUSD;
    ...
    address rewardPool = address(0x9CFcfb1513Ad5fC4C868D92fA79753d937C327fE);
    ...
    function setUp() public virtual {
        ...
        feedDolascrvUSD = _deployDolascrvUSDFeed();
        market = new Market(
            gov,
            fedAddr,
            pauseGuardian,
        ...
        _advancedInit(address(market), address(feedDolascrvUSD), true);
