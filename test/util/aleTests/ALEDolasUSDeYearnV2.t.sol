...
contract ALEDolasUSDeYearnV2Test is DolasUSDeYearnV2MarketForkTest {
    ALE ale;
    IFlashMinter flash;
    ...
    function setUp() public override {
        ...
        helper.setMarket(address(market), address(dolasUSDe), 0, 2, yearn);
    ...
    function test_leveragePosition() public {
        ...
        uint256 lpAmountAdded = dolasUSDe.calc_token_amount(amounts, true);
    ...
    function test_leveragePosition_buyDBR() public {
        ...
        uint256 sharesAdded = YearnVaultV2Helper.assetToCollateral(
            vault,
            dolasUSDe.calc_token_amount(amounts, true)
        );
        vm.prank(userPk);
        ale.leveragePosition(
            maxBorrowAmount,
    ...
    function test_deleveragePosition(uint sharesAmount) public {
        ...
        uint256 dolaRedeemed = dolasUSDe.calc_withdraw_one_coin(
