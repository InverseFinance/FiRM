...
contract DolaCrvUSDDolaEscrowForkTest is Test {
    address market = address(0xA);
    address beneficiary = address(0xB);
    address friend = address(0xC);
    address holder = address(0xb634316E06cC0B358437CbadD4dC94F1D3a92B3b);
    address yearnHolder = address(0x8B5b1D02AAB4e10e49507e89D2bE10A382D52b57); //updated
    IERC20 dolaFraxBP = IERC20(0x8272E1A3dBef607C04AA6e5BD3a1A134c8ac063B); // crvUSD/Dola
    ...
    IRewardPool rewardPool =
        IRewardPool(0xC94208D230EEdC4cDC4F80141E21aA485A515660);

    IConvexBooster booster =
        IConvexBooster(0xF403C135812408BFbE8713b5A23a04b3D48AAE31);
    IERC20 depositToken = IERC20(0x408abF1a02388A5EF19E3dB1e08db5eFdC510DFF);
    ...
    address stash = 0x25F5Ccd892985Bf878327B15815bd90066EEf28d; //setExtraReward(token)
