 ...
 */
contract PrivateBorrowController {
    ...
    /**
     * @notice Allows a borrower to interact with a private FiRM market
     * @param market The private FiRM market
    ...
    function borrowAllowed(address msgSender, address borrower, uint amount) public returns (bool) {
        ...
        //Check if borrower is an allowed borrower
        return allowedBorrowers[msg.sender][msgSender];
    }
